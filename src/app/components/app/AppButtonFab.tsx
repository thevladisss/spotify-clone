...
type AppButtonFabProps = {
  iconSize?:string
} & FabProps & PropsWithChildren & HTMLProps<any>;
...
function AppButtonFab(props: AppButtonFabProps): JSX.Element {
  ...
  return (
    <Button className={AppButtonClasses} {...propsAndAttrs} style={{
      minWidth: "48px",
      height: "48px",
      width: "48px",
      borderRadius: "50%"
    }}>
      <span style={{width: props.iconSize, height: props.iconSize}}>{ children}</span>
    </Button>
  )
}
